...
struct me_struct
{
	int start;
	int done;
	int (*func)(void*);		// function ptr - func takes an int argument and returns int
	void* param;				// function argument
...
int CallME(volatile struct me_struct *mei, int (*func)(void*), void* param, int prelen, void *preadr, int postlen, void *postadr);
int WaitME(volatile struct me_struct *mei);
int BeginME(volatile struct me_struct *mei, int (*func)(void*), void* param, int prelen, void *preadr, int postlen, void *postadr);
